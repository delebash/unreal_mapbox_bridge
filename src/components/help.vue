  ...
  <q-dialog class="dialog-plugin" ref="dialog" @hide="onDialogHide">
    <q-card style="width:600px;height:600px">
      <q-card-section class="row items-center no-wrap" style="height:50px">
        <div>
          <div class="text-weight-bold">Help</div>
        </div>
        <q-space></q-space>
      ...
      >
        ...
        <div class="q-ml-md">
          <div><u>Export Type:</u>
            <ul>
              ...
              <li>
                <u>Unreal Terrain Magic Plugin</u> -- Needs custom C++ adjustment to work. You need to install the paid plugin <a href="https://github.com/GDi4K/unreal-terrain-magic">Terrain Magic</a>.
              ...
              <li>
                <u>Unreal Stamp Brush Plugin</u> -- You need to install paid plugin <a href="https://www.unrealengine.com/marketplace/en-US/product/landscape-stamping-tool-100-custom-brushes?sessionInvalidated=true">Landscape Stamping Tool - 100+ Custom Brushes</a>.
          ...
          <div><u>Export Options:</u>
            <ul>
              <li>
                <u>Zrange-sea level=</u> -- By checking this the imported heightmap will keep the landscape height near 100
                Unreal Units.
              </li>
              <li>
              ...
              <li>
                <u>Download Satellite</u> -- Downloads a Satellite Image of the selected area. This can be used as on overlay
                in UE.
              </li>
              <li>
                <u>Download Geojson Features</u> -- Downloads the features of the selected area in geojson format. Search
                Mapbox for geosjon.
              </li>
              <li>
        ...
        <div><u>Buttons:</u>
          <ul>
            ...
            <li>
              <u>Send To Unreal</u> -- Automatically imports heightmap or stamp into your Unreal project. Required -- Mapbox_BP has to be installed in to your unreal project and configured.
              You can download the free plugin here <a href="https://github.com/delebash/UnrealMapboxBridgePlugin">Unreal Mapbox Bridge Plugin</a>.
            </li>
            <li>
              <u>Copy Bounds for Blender OSM</u> -- A plugin for blend that downloads real world map info into blender.  It has it's own
              map but you can use this one as well since it has a search by name feature. Download <a href="https://github.com/vvoovv/blender-osm">Blender OSM</a>.
            </li>
            <li>
              <u>Copy Slippy Tile Info String</u> -- This format is used in many other GIS applications to download map tile information. This is just
