<template>
  <q-layout view="lHr lpr lfr">
    ...
    <q-drawer show-if-above v-model="drawerLeft" side="left" @hide='resizeMap' class="no-margin no-padding">
      ...
      <q-page class="row no-margin q-pa-sm">
        <q-card class="col">
          <q-tabs
            ...
            narrow-indicator
          >
            <q-btn flat @click="changeDrawer" round dense icon="menu"/>
          ...
          <q-tab-panels keep-alive v-model="selectedTab" animated>
            ...
            <q-tab-panel name="settings">
              See: <a href="https://docs.mapbox.com/help/glossary/access-token/" target="_blank">Mapbox access token docs</a>
              <q-input v-model="access_token" label="Mapbox Access Token *" filled
              ...
              <q-input class="q-pb-lg" v-model="style_url" label="Enter your Mapbox style url *" filled
                       lazy-rules
              ...
              <q-input class="q-pb-lg" v-model="dir_name" label="Enter download directory path *"
                ...
                <q-btn align="right" @click="fileDownloadDirectory()" color="secondary"
                       label="Select download folder"></q-btn>
              </q-input>
              <q-btn @click="saveUserSettings()" color="secondary"
